...
import (
	...
	"gitlab.com/jaderabbit/go-rabbit/services/transmission"
	"gitlab.com/jaderabbit/go-rabbit/src/chain"
...
func GetContainerName(chaincodeName string) (string, error) {
	...
	definition, err := chain.GetChaincodeDefinition(config.ChannelID, config.ChaincodeName)
	if err != nil {
