...
// Container for the sibling is created by the docker container, which constructs a sibling docker container in the
// docker container to perform trusted execution as a trusted execution environment.
...
func (c *Container) Create() error {
	...
	c.address = "/tmp/teetask/container/"
	c.client = client
	c.startFunc = func(cmd string) (*docker.Container, error) {
		return c.client.CreateContainer(docker.CreateContainerOptions{
