...
import (
	...
	"gitlab.com/jaderabbit/go-rabbit/tee/protos/service"
)
...
func (s *Service) UploadFile(ctx context.Context, req *service.UploadFileRequest) (*service.UploadFileResponse, error) {
	...
	return &service.UploadFileResponse{FileId: fileID}, ioutil.WriteFile(filePath, req.Data, 0755)
}

// DownloadFile is used to process the file requested by the client to download.
func (s *Service) DownloadFile(ctx context.Context, req *service.DownloadFileRequest) (*service.DownloadFileResponse, error) {
	...
	return &service.DownloadFileResponse{Data: data}, nil
}
